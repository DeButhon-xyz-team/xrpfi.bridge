...
const sendXRP = async () => {
    ...
    try {
        ...
        const balance = (0, xrpl_1.dropsToXrp)(accountInfo.result.account_data.Balance);
        ...
        const prepared = await client.autofill({
            ...
            Account: wallet.address,
            Amount: (0, xrpl_1.xrpToDrops)(amountToSend),
        ...
        console.log(`새 잔액: ${(0, xrpl_1.dropsToXrp)(newAccountInfo.result.account_data.Balance)} XRP`);
        // API 호출 제안
